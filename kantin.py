...
st.markdown("<p style='text-align: center; color: #475569; font-weight: 800; font-size: 3rem; text-shadow: 1px 1px 1px rgba(255,255,255,0.8); margin-bottom: 25px;'>Contoh 00003950</p>", unsafe_allow_html=True)
